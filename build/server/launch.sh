...
JAVA_CMD="$JAVA_HOME/bin/java" # you can change it to like /usr/lib/jvm/java-8-openjdk/bin/java  if you need a different version without changing the global one
