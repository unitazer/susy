...
eventManager.listen { PostMaterialEvent event ->
    ...
    new StandardMetaItem(2 as short).with {
        ...
        Batteries['ni_zn.lv'].register(it, 4011)
        Batteries['ni_zn.mv'].register(it, 4012)
        Batteries['ni_zn.hv'].register(it, 4013)
        addItem(4014, "anode.zinc_oxide")
        addItem(4015, "cathode.nioh2")
        Batteries['ni_cd.hv'].register(it, 4016)
        Batteries['ni_cd.ev'].register(it, 4017)
        Batteries['ni_cd.iv'].register(it, 4018)
        addItem(4019, "anode.cadmium_oxide")
        Batteries['ni_mh.ev'].register(it, 4020)
        Batteries['ni_mh.iv'].register(it, 4021)
        Batteries['ni_mh.luv'].register(it, 4022)
        addItem(4023, "anode.metal_hydride")
        addItem(4024, "electrode.nickeled_steel_foil")
        addItem(4025, "membrane.caprolatam")
        addItem(4026, "membrane.caprolatam_wet")
        addItem(4027, "membrane.caprolatam_quenched")
        addItem(4028, "membrane.caprolatam_casted")
