...
class FirstDegreeMaterialsA {
    ...
    static void register() {
        ...
        CobaltMatte.setFormula("(Co)(?)", true)
        ...
        IronIIISulfate.setFormula("Fe2(SO4)3", true)
        ...
        EnargiteResidue.setFormula("(?)Cu2S", true)
        ...
        ProustiteAlkalineLeachSolution.setFormula("(Na3AsS3)(H2O)", true)
        ...
        CrudeArsenicTrichloride.setFormula("(?)(AsCl3)", true)
        ...
        EnargiteSulfideLeachSolution.setFormula("(Na3AsS4)(H2O)", true)
        ...
        SperryliteWaste.setFormula("[(Ni,Co)Cl2](H2O)4", true)
        ...
        AcidicCopperSolution.setFormula("(Cu(NO3)2)2(H2SO4)(H2O)6", true)
        ...
        SulfidicSilverCyanideSolution.setFormula("(Na[Ag(CN)2])2(Na2S)(H2O)8", true)
        ...
        SilverCyanideSolution.setFormula("(Na[Ag(CN)2])2(NaCl)2(H2O)4", true)
        ...
        SulfidicPyrargyriteCyanideLeachSolution.setFormula("(Na[Ag(CN)2])3(Na3SbS3)(H2O)12", true)
        ...
        PyrargyriteCyanideLeachSolution.setFormula("(Na[Ag(CN)2])3(NaCl)3(H2O)12", true)
        ...
        PyrargyriteThiosulfateLeachSolution.setFormula("(Na3[Ag(S2O3)2])3(Na3SbS3)(H2O)5", true)
        ...
        ThiosulfateThioantimoniteSolution.setFormula("(Na2S2O3)6(Na3SbS3)(H2O)5", true)
        ...
        ThiosulfateThioarseniteSolution.setFormula("(Na2S2O3)6(Na3AsS3)(H2O)5", true)
        ...
        SulfidicStephaniteCyanideLeachSolution.setFormula("(Na[Ag(CN)2])5(Na3SbS3)(Na2S)(H2O)20", true)
        ...
        StephaniteCyanideLeachSolution.setFormula("(Na[Ag(CN)2])5(NaCl)3(H2O)20", true)
        ...
        ProustiteThiosulfateLeachSolution.setFormula("(Na3[Ag(S2O3)2])3(Na3AsS3)(H2O)5", true)
        ...
        AcidicArsenateVSolution.setFormula("(H3AsO4)3(HNO3)6", true)
        ...
        IronIIIHydroxide.setFormula("Fe(OH)3", true)
        ...
        CrudeGalliumTrichloride.setFormula("(?)GaCl3", true)
        ...
        GalliumTrichloride.setFormula("GaCl3", true)
        ...
        CrudeIronPentacarbonyl.setFormula("Fe(CO)5", true)
        ...
        RoastedPetalite.setFormula("(LiAlSi2O6)(SiO2)2", true)
        ...
        BerylliumHydroxide.setFormula("Be(OH)2", true)
        ...
        ManganeseIINitrate.setFormula("Mn(NO3)2", true)
        ...
        CrudeManganeseIIOxide.setFormula("(?)(MnO)", true)
        ...
        ManganeseIINitrateSolution.setFormula("(Mn(NO3)2)(H2O)", true)
        ...
        CrudeManganeseIINitrateSolution.setFormula("(?)(Mn(NO3)2)(H2O)", true)
        ...
        ImpureLithiumCarbonate.setFormula("(C)(Li2CO3)", true)
        ...
        MoistArgon.setFormula("(Ar)(H2O)", true)
        ...
        ArgonHydrogenMixture.setFormula("(Ar)(H)", true)
