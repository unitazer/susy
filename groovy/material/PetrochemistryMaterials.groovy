...
class PetrochemistryMaterials {
    ...
    static void register() {
        ...
        RawMonoxideRichSyngas.setFormula('(H2)2(CO)(?)', true)
        ...
        RawHydrogenRichSyngas.setFormula('(H2)2.5(CO)(?)', true)
        ...
        HydrogenRichSyngas.setFormula('(H2)2.5(CO)', true)
        ...
        ReformedHydrogenRichSyngas.setFormula('(H2)3.5(CO2)', true)
        ...
        MonoxideRichSyngas.setFormula('(H2)2(CO)', true)
        ...
        ReformedMonoxideRichSyngas.setFormula('(H2)3(CO2)', true)
