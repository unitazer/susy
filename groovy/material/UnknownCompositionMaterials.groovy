...
class UnknownCompositionMaterials {
    ...
    static void register() {
        ...
        CrudeAcrylonitrile = new Material.Builder(4683, SuSyUtility.susyId('crude_acrylonitrile'))
                ...
                .color(0x5c8c24)
                .build()
        NaphthenicAcid = new Material.Builder(4684, SuSyUtility.susyId('naphthenic_acid'))
                .liquid()
                .color(0x5E5925)
                .build()
        ImpureSodiumSoapSolution = new Material.Builder(4685, SuSyUtility.susyId('impure_sodium_soap_solution'))
                .liquid()
                .color(0xC8C9B4)
                .build()
        ClarifiedSodiumSoapSolution = new Material.Builder(4686, SuSyUtility.susyId('clarified_sodium_soap_solution'))
                .liquid()
                .color(0xF3F3EF)
                .build()
        SodiumSoapSolution = new Material.Builder(4687, SuSyUtility.susyId('sodium_soap_solution'))
                .liquid()
                .color(0xBAD4E8)
                .build()
        ClearSodiumSoapSolution = new Material.Builder(4688, SuSyUtility.susyId('clear_sodium_soap_solution'))
                .liquid()
                .color(0xE6F2FD)
                .build()
        ColloidalAluminiumSoap = new Material.Builder(4689, SuSyUtility.susyId('colloidal_aluminium_soap'))
                .liquid()
                .color(0xAC75B6)
                .build()
        Napalm = new Material.Builder(4690, SuSyUtility.susyId('napalm'))
                .liquid()
                .color(0xFEF7BA)
                .flags(FLAMMABLE)
                .build()
        ImpureAluminiumSoap = new Material.Builder(4691, SuSyUtility.susyId('impure_aluminium_soap'))
                .dust()
                .color(0xC8CAA5)
                .build()
        WetAluminiumSoap = new Material.Builder(4692, SuSyUtility.susyId('wet_aluminium_soap'))
                .dust()
                .color(0xDCDFB0)
                .build()
        NapalmGellingAgent = new Material.Builder(4692, SuSyUtility.susyId('napalm_gelling_agent'))
                .dust()
                .color(0xF3E997)
                .build()
