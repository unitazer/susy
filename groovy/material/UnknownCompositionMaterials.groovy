...
class UnknownCompositionMaterials {
    ...
    static void register() {
        ...
        CrudeAcrylonitrile = new Material.Builder(4683, SuSyUtility.susyId('crude_acrylonitrile'))
                ...
                .color(0x5c8c24)
                .build()
        NaphthenicAcid = new Material.Builder(4694, SuSyUtility.susyId('naphthenic_acid'))
                .liquid()
                .color(0x5E5925)
                .build()
        ImpureSodiumSoapSolution = new Material.Builder(4695, SuSyUtility.susyId('impure_sodium_soap_solution'))
                .liquid()
                .color(0xC8C9B4)
                .build()
        ...
        WetAluminiumSoap = new Material.Builder(4692, SuSyUtility.susyId('wet_aluminium_soap'))
                ...
                .color(0xDCDFB0)
                .build()
        NapalmGellingAgent = new Material.Builder(4693, SuSyUtility.susyId('napalm_gelling_agent'))
                .dust()
                .color(0xF3E997)
                .build()
