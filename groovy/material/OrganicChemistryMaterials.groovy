...
class OrganicChemistryMaterials {
    static void register() {
        ...
        EthylenediaminetetraaceticAcid.setFormula('(H4EDTA)', true)
        ...
        TributylPhosphite = new Material.Builder(15477, SuSyUtility.susyId('tributyl_phosphite'))
                .liquid()
                .components(Carbon * 12, Hydrogen * 27, Oxygen * 3, Phosphorus * 1)
                .color(0xc3bec4)
                .build()

        Acetanilide = new Material.Builder(15478, SuSyUtility.susyId('acetanilide'))
                .dust()
                .components(Carbon * 8, Hydrogen * 9, Nitrogen, Oxygen)
                .color(0xE6E6E6)
                .build()

        NAcetylsulfanilylChloride = new Material.Builder(15479, SuSyUtility.susyId('n_acetylsulfanilyl_chloride'))
                .dust()
                .components(Carbon * 8, Hydrogen * 8, Chlorine, Nitrogen, Oxygen * 3, Sulfur)
                .color(0xF5F0E6)
                .build()   
        Guanidine = new Material.Builder(15480, SuSyUtility.susyId('guanidine'))
              .dust()
              .components(Carbon, Hydrogen * 5, Nitrogen * 3)
              .color(0xE7E7E7)
              .build()

        GuanidiniumChloride = new Material.Builder(15481, SuSyUtility.susyId('guanidinium_chloride'))
              .dust()
              .components(Carbon, Hydrogen * 6, Nitrogen * 3, Chlorine)
              .color(0xE7E7E7)
              .build()

        Tetramethoxypropane = new Material.Builder(15482, SuSyUtility.susyId('tetramethoxypropane'))
                .liquid()
                .components(Carbon * 7, Hydrogen * 16, Oxygen * 4)
                .color(0xE1EBEE)
                .build()

        TrimethylOrthoformate = new Material.Builder(15483, SuSyUtility.susyId('trimethyl_orthoformate'))
                .liquid()
                .components(Carbon * 4, Hydrogen * 10, Oxygen * 3)
                .color(0xE1EBEE)
                .build()

        MethylVinylEther = new Material.Builder(15484, SuSyUtility.susyId('methyl_vinyl_ether'))
               .gas() 
               .components(Carbon * 3, Hydrogen * 6, Oxygen)
               .color(0xE5E5E5)
               .build()
        
        TwoAminopyrimidine = new Material.Builder(15485, SuSyUtility.susyId('two_aminopyrimidine'))
                .dust()
                .components(Carbon * 4, Hydrogen * 5, Nitrogen * 3)
                .color(0xE7E7E7)
                .build()
        
        SulfonamideIntermediate = new Material.Builder(15486, SuSyUtility.susyId('sulfonamide_intermediate'))
                .dust()
                .components(Carbon * 12, Hydrogen * 12, Nitrogen * 4, Oxygen * 3, Sulfur)
                .color(0xF5F3D0)
                .build()
        
        Sulfadiazine = new Material.Builder(15487, SuSyUtility.susyId('sulfadiazine'))
                .dust()
                .components(Carbon * 10, Hydrogen * 10, Nitrogen * 4, Oxygen * 2, Sulfur)
                .color(0xF5F3D0)
                .build()
        
        SodiumAcetate = new Material.Builder(15488, SuSyUtility.susyId('sodium_acetate'))
                .dust()
                .components(Carbon * 2, Hydrogen * 3, Sodium, Oxygen * 2)
                .color(0xE7E7E7)
                .build()

        SodiumAcetateSolution = new Material.Builder(15489, SuSyUtility.susyId('sodium_acetate_solution'))
                .fluid()
                .components(SodiumAcetate * 1, Water * 1)
                .color(0xE6F7FF)
                .build()
