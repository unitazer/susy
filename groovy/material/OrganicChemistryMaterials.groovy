...
class OrganicChemistryMaterials {
    static void register() {
        ...
        NAcetylsulfanilylChloride = new Material.Builder(15499, SuSyUtility.susyId('n_acetylsulfanilyl_chloride'))
                ...
                .color(0xF5F0E6)
                .build()   
        Guanidine = new Material.Builder(15500, SuSyUtility.susyId('guanidine'))
              .dust()
              .components(Carbon, Hydrogen * 5, Nitrogen * 3)
              .color(0xE7E7E7)
              .build()

        GuanidiniumChloride = new Material.Builder(15501, SuSyUtility.susyId('guanidinium_chloride'))
              .dust()
