...
class ThermodynamicsMaterials {
    ...
    static void register() {
        ...
        ColdAmmoniacalArgonHydrogenMixture.setFormula("(Ar)(NH3)(H)", true)
        ...
        ColdArgonHydrogenMixture.setFormula("(Ar)(H)", true)
        ...
        PartiallyLiquefiedArgonHydrogenMixture.setFormula("(Ar)(H)", true)
