...
class Batteries {
    ...
    static list = [
        ...
        new Battery('ni_zn.lv', GTValues.LV, secs[2]),
        new Battery('ni_zn.mv', GTValues.MV, secs[2]),
        new Battery('ni_zn.hv', GTValues.HV, secs[1]),
        new Battery('ni_cd.hv', GTValues.HV, secs[1]),
        new Battery('ni_cd.ev', GTValues.EV, secs[0]),
        new Battery('ni_cd.iv', GTValues.IV, secs[0]),
        new Battery('ni_mh.ev', GTValues.EV, secs[1]),
        new Battery('ni_mh.iv', GTValues.IV, secs[1]),
        new Battery('ni_mh.luv', GTValues.IV, secs[0]),
    ]
