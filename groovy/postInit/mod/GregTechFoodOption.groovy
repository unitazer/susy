...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('sodium_vanillylmandelate_solution') * 3000)
    .duration(160)
    .EUt(GTValues.VA[GTValues.MV])
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('sodium_vanillylmandelate_solution') * 3000)
    .fluidOutputs(fluid('sodium_vanilglycolate_solution') * 4000)
    .duration(160)
    .EUt(GTValues.VA[GTValues.MV])
    .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .fluidInputs(fluid('sodium_vanilglycolate_solution') * 4000)
