...
CSTR.recipeBuilder()
        ...
        .fluidOutputs(fluid('phenolic_cresol_infiltrant') * 100)
        .duration(4)
        .EUt(VA[MV])
        .buildAndRegister();
...
CSTR.recipeBuilder()
        ...
        .fluidInputs(fluid('phenolic_cresol_infiltrant') * 25)
        .fluidOutputs(fluid('diluted_phenolic_cresol_infiltrant') * 100)
        .duration(2)
        .EUt(VA[MV])
        .buildAndRegister();
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .fluidInputs(fluid('diluted_phenolic_cresol_infiltrant') * 4000)
