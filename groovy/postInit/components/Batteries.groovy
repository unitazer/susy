...
MIXER.recipeBuilder()
        ...
        .fluidIutputs(fluid('tetrahydrofuran') * 720)
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .fluidInputs(fluid('polycaproclatam_solution') * 144)
...
ARC_FURNACE.recipeBuilder()
        ...
        .outputs(metaitem('AnnaelledAB2metalalloy'))
        .EUt(VA[EV])
        .duration(120)
        .buildAndRegister()
...
ARC_FURNACE.recipeBuilder()
        ...
        .outputs(metaitem('AnnaelledAB5metalalloy'))
        .EUt(VA[EV])
        .duration(120)
        .buildAndRegister()
...
MIXER.recipeBuilder()
        ...
        .inputs(ore('dustAnnaelledAB2metalalloy') * 3)
        .inputs(ore('dustHighPurityCopper'))
        .outputs(metaitem('anode.MetalHydrideMix') * 10)
        .EUt(VA[EV])
        .duration(20)
        .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
        .inputs(metaitem('electrode.nickeled_steel_foil'))
        .inputs(ore('cathode.MetalHydrideMix'))
        .inputs(ore('dustPolyvinylideneFluoride'))
        .inputs(ore('dustAnyPurityCarbon'))
        .outputs(metaitem('anode.MetalHydride'))
        .duration(200)
        .EUt(VA[EV])
        .buildAndRegister()
