...
ELECTROLYTIC_CELL.recipeBuilder()
        .notConsumable(ore('dustBoricAcid') * 7)
        .notConsumable(fluid('nickel_sulfate_solution') * 1000)
        .notConsumable(fluid('nickel_chloride_solution') * 1000)
...
//mods.jei.ingredient.removeAndHide(metaitem('battery.re.mv.sodium'))
// Lithium Battery
