...
MIXER.recipeBuilder()
        .inputs(ore('dustCaprolatam'))
        .fluidIutputs(fluid('water') * 200)
        .outputs(metaitem('membrane.caprolatam_wet'))
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .fluidInputs(fluid('doped_caprolatam_solution') * 144)
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .fluidInputs(fluid('tetrahydrofuran') * 500)
        .fluidInputs(fluid('watere') * 500)
        .outputs(metaitem('membrane.caprolatam'))
        .outputs(ore('foilPlastic'))
        .EUt(VA[ULV])
        .duration(40)
        .buildAndRegister()

MIXER.recipeBuilder()
        .inputs(metaitem('membrane.caprolatam_quenched'))
        .fluidIutputs(fluid('water') * 200)
        .outputs(metaitem('membrane.caprolatam_wet'))
        .fluidOutputs(fluid('wastewater') * 100)
        .duration(100)
...
DRYER.recipeBuilder()
        .inputs(metaitem('membrane.caprolatam_wet'))
        .outputs(metaitem('membrane.caprolatam'))
...
VACUUM_CHAMBER.recipeBuilder()
        ...
        .fluidInputs(fluid('potassium_hydroxide_solution') * 4000)
        .outputs(metaitem('battery.ni_cd.iv'))
        .duration(200)
        .EUt(VA[HV])
        .buildAndRegister()
