...
mods.gregtech.assembler.recipeBuilder()
        ...
        .outputs(metaitem('foilPunchedPolyacrylonitrile'))
        .duration(40)
        .EUt(VA[HV])
        .buildAndRegister()

mods.gregtech.pyrolyse_oven.recipeBuilder()
        .inputs(ore('foilPunchedPolyacrylonitrile'))
        .outputs(metaitem('foilCarbonFelt'))
        .duration(300)
        .EUt(VA[HV])
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(ore('foilCarbonFelt'))
        .fluidInputs(fluid('oxygen') * 1000)
        .outputs(metaitem('foilActivatedCarbonFelt'))
        .duration(180)
        .EUt(VA[MV])
        .buildAndRegister()
...
TUBE_FURNACE.recipeBuilder()
        ...
        .fluidOutputs(fluid('vanadium_trioxide_waste_gas') * 1000)
...
ROASTER.recipeBuilder() //maybe dryer is better? source says ~220C
...
MIXER.recipeBuilder()
        ...
        .fluidInputs(fluid('gtfo_heated_water') * 14000)
...
POLYMERIZATION_TANK.recipeBuilder()
        ...
        .notConsumable(fluid('tert_butyl_hydroperoxide') * 1000)
        .outputs(metaitem('dustPolydiallyldimethylammoniumChloride') * 1)
        .duration(350)
        .EUt(VA[HV])
        .buildAndRegister()
...
MIXER.recipeBuilder()
        ...
        .fluidInputs(fluid('diluted_nitric_acid') * 1000)
        .fluidOutputs(fluid('very_diluted_nitric_acid') * 2000)
        .duration(40)
        .EUt(VA[LV])
        .buildAndRegister()
...
ELECTROLYZER.recipeBuilder()
        ...
        .fluidInputs(fluid('very_diluted_nitric_acid') * 1000) //source says 5%, I felt 25% is close enough for susy
        .notConsumable(metaitem('stickPlatinum') * 1)
        .fluidOutputs(fluid('graphene_oxide_solution') * 1000)
        .duration(200)
        .EUt(VA[HV])
        .buildAndRegister()

DRYER.recipeBuilder()
        .fluidInputs(fluid('graphene_oxide_solution') * 1000)
...
BR.recipeBuilder()
        .inputs(metaitem('dustTinyPolydiallyldimethylammoniumChloride') * 1)
        .inputs(metaitem('dustGrapheneOxide') * 1)
        .fluidInputs(fluid('sodium_tungstate_solution') * 300) 
        .fluidOutputs(fluid('graphene_oxide_polydadmac_tungstate_solution') * 300)
        .duration(240)
        .EUt(VA[EV])
        .buildAndRegister()

BR.recipeBuilder()
        .fluidInputs(fluid('graphene_oxide_polydadmac_tungstate_solution') * 300)
        .fluidInputs(fluid('hydrochloric_acid') * 600)
        .fluidOutputs(fluid('tungstic_acid_coated_graphene_oxide_nanosheet_solution') * 900)
        .duration(400)
        .EUt(VA[HV])
        .buildAndRegister()

CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('tungstic_acid_coated_graphene_oxide_nanosheet_solution') * 900)
        .outputs(metaitem('dustTungsticAcidCoatedGrapheneOxideNanosheet') * 1)
        .fluidOutputs(fluid('salt_water') * 900)
        .duration(300)
        .EUt(VA[EV])
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .inputs(metaitem('dustTungsticAcidCoatedGrapheneOxideNanosheet') * 1)
        .outputs(metaitem('dustRinsedTungsticAcidCoatedGrapheneOxideNanosheet') * 1)
        .duration(200)
        .EUt(VA[MV])
        .buildAndRegister()
...
TUBE_FURNACE.recipeBuilder() //source says "annealed in a muffle furnace", tube furnace is imo the closest, though it could be the resistance furnace
        .inputs(metaitem('dustRinsedTungsticAcidCoatedGrapheneOxideNanosheet') * 1)
        .outputs(metaitem('dustTungstenTrioxideNanoparticleCoatedGrapheneOxideNanosheet') * 1)
        .duration(200)
        .EUt(VA[HV])
        .buildAndRegister()
...
MIXER.recipeBuilder()
        ...
        .fluidOutputs(fluid('water_nafion_solution') * 1000)
        .duration(140)
        .EUt(VA[MV])
        .buildAndRegister()

MIXER.recipeBuilder()
        .fluidInputs(fluid('water_nafion_solution') * 1000)
        .inputs(metaitem('dustTinyTungstenTrioxideNanoparticleCoatedGrapheneOxideNanosheet') * 1)
        .fluidOutputs(fluid('tungsten_trioxide_graphene_oxide_doped_nafion_solution') * 1000)
        .duration(320)
        .EUt(VA[EV])
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('tungsten_trioxide_graphene_oxide_doped_nafion_solution') * 1000)
        .fluidOutputs(fluid('water') * 1000)
        .outputs(metaitem('dustTungstenTrioxideGrapheneOxideDopedNafion'))
        .duration(400)
        .EUt(VA[LV])
        .buildAndRegister()

ASSEMBLER.recipeBuilder()
        .inputs(metaitem('foilTungstenTrioxideGrapheneOxideDopedNafion') * 4)
        .inputs(metaitem('platePolytetrafluoroethylene') * 1)
...
RESISTANCE_FURNACE.recipeBuilder()
        .inputs(metaitem('dustExpandableGraphite') * 4)
        .notConsumable(metaitem('springCupronickel'))
        .outputs(metaitem('expanded_graphite_worms') * 16)
        .duration(100)
        .EUt(4)
        .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
        ...
        .inputs(metaitem('foilActivatedCarbonFelt') * 2)
