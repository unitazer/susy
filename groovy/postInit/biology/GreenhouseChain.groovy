...
MIXER.recipeBuilder()
        .inputs(ore('dustDiammoniumHydrogenPhosphate') * 2)
        .inputs(ore('nutrientPotassium'))
        .outputs(metaitem('fertilizer') * 5)
        .EUt(VA[LV])
        .duration(100)
...
//THIS IS FOR ARBORETUMS IN OUTER SPACE
...
ARBORETUM.recipeBuilder()
        ...
        .fluidOutputs(fluid('gtfo_rainbow_sap') * 1000)
        .EUt(VA[LV])
        .duration(360)
        .buildAndRegister()
...
ARBORETUM.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_leaves_1', 12) * 12)
        .outputs(item('gregtechfoodoption:gtfo_sapling_0', 14) * 2)
        .fluidOutputs(fluid('gtfo_rainbow_sap') * 2000)
        .EUt(VA[LV])
        .duration(360)
        .buildAndRegister()
...
ARBORETUM.recipeBuilder()
        ...
        .outputs(metaitem('gregtechfoodoption:component.coconut') * 2)
        .EUt(VA[LV])
        .duration(360)
        .buildAndRegister()
...
ARBORETUM.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_leaves_2', 4) * 12)
        .outputs(item('gregtechfoodoption:gtfo_sapling_1', 2) * 2)
        .outputs(metaitem('gregtechfoodoption:component.coconut') * 4)
        .EUt(VA[LV])
        .duration(360)
        .buildAndRegister()
...
GREENHOUSE.recipeBuilder()
        .notConsumable(item('minecraft:cactus') * 4)
        .notConsumable(item('minecraft:sand') * 4)
        .fluidInputs(fluid('water') * 400)
        .outputs(item('minecraft:cactus') * 16)
        .duration(600)
        .EUt(60)
        .buildAndRegister();