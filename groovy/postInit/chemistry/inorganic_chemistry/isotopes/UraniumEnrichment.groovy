...
GAS_CENTRIFUGE.recipeBuilder()
    .fluidInputs(fluid('reprocessed_uranium_hexafluoride') * 1000)
    .fluidOutputs(fluid('depleted_uranium_hexafluoride') * 840)
    .fluidOutputs(fluid('leu_235_hexafluoride') * 160)
    .duration(7200)
    .EUt(VA[HV])
    .buildAndRegister()
