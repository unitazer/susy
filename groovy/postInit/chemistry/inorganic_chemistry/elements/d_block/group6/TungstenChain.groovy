...
ROASTER.recipeBuilder()
        ...
        .fluidOutputs(fluid('hydrogen_chloride') * 25)
...
BLENDER.recipeBuilder()
        .fluidInputs(fluid('kerosene') * 650)
        .fluidInputs(fluid('trioctylamine') * 1250)
        .fluidInputs(fluid('isodecanol') * 100)
        .fluidOutputs(fluid('tungsten_extraction_mixture') * 2000)
        .EUt(VA[EV])
        .duration(200)
        .buildAndRegister()
...
ROASTER.recipeBuilder()
        ...
        .outputs(metaitem('dustTungstenTrioxide') * 48)
