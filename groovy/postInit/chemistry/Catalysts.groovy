...
ROASTER.recipeBuilder()
    .inputs(ore('dustBoehmite') * 8)
    .outputs(metaitem('dustGammaAlumina') * 5)
...
BALL_MILL.recipeBuilder()
    .inputs(ore('dustGammaAlumina'))
    .outputs(metaitem('dustFineGammaAlumina'))
    .duration(40)
    .EUt(VA[LV])
    .buildAndRegister()

MIXER.recipeBuilder()
    .inputs(ore('dustFineGammaAlumina') * 45)
    .fluidInputs(fluid('chloroplatinic_acid_solution') * 4000)
    .fluidInputs(fluid('distilled_water') * 2000)
    .outputs(metaitem('dustSupportedPlatinumChloride') * 45)
    .duration(100)
    .EUt(VA[MV])
    .buildAndRegister()

SINTERING_OVEN.recipeBuilder()
    .inputs(ore('dustSupportedPlatinumChloride') * 45)
    .fluidInputs(fluid('hydrogen') * 4000)
    .outputs(metaitem('dustSupportedPlatinum') * 9)
...
MIXER.recipeBuilder()
    ...
    .outputs(metaitem('dustSupportedPalladiumChloride') * 45)
    .duration(100)
    .EUt(VA[MV])
    .buildAndRegister()

SINTERING_OVEN.recipeBuilder()
    .inputs(ore('dustSupportedPalladiumChloride') * 45)
    .fluidInputs(fluid('hydrogen') * 2000)
    .outputs(metaitem('dustSupportedPalladium') * 9)
...
BR.recipeBuilder()
    ...
    .outputs(metaitem('dustChloridedAlumina') * 5)
    .duration(100)
    .EUt(VA[LV])
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .outputs(metaitem('dustBasicCopperCarbonate') * 10)
...
MIXER.recipeBuilder()
    ...
    .outputs(metaitem('dustRaneyCopper') * 2)
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister()

BR.recipeBuilder()
    .inputs(ore('dustRaneyCopper') * 4)
    .inputs(ore('dustSodiumHydroxide') * 6)
    .fluidInputs(fluid('distilled_water') * 5000)
    .outputs(metaitem('dustActivatedRaneyCopper') * 2)
    .fluidOutputs(fluid('sodium_aluminate_solution') * 3000)
    .fluidOutputs(fluid('hydrogen') * 6000)
    .duration(240)
    .EUt(VA[LV])
