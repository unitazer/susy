...
DISTILLERY.recipeBuilder()
        ...
        .circuitMeta(1)
        .fluidOutputs(fluid('sulfuric_acid') * 700)
        .duration(120)
        .EUt(VA[ULV])
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('green_vitriol_solution') * 8000)
        .duration(1200)
        .EUt(VA[ULV])
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('green_vitriol_solution') * 1000)
        .circuitMeta(1)
        .outputs(metaitem('dustGreenVitriol') * 3)
        .duration(120)
        .EUt(VA[ULV])
        .buildAndRegister()
