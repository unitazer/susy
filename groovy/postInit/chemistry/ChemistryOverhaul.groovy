...
CSTR.recipeBuilder()
    ...
    .fluidOutputs(fluid('ammonium_bisulfate_solution') * 50)
    .duration(1)
    .EUt(VA[LV])
    .buildAndRegister()
...
BCR.recipeBuilder()
    .fluidInputs(fluid('diluted_salt_water') * 100)
...
PHASE_SEPARATOR.recipeBuilder()
    ...
    .outputs(metaitem('dustChloronitrobenzeneMixture'))
    .fluidOutputs(fluid('diluted_sulfuric_acid') * 2000)
    .duration(50)
    .buildAndRegister()

CRYSTALLIZER.recipeBuilder()
    .fluidInputs(fluid('chloronitrobenzene_mixture') * 144)
...
BR.recipeBuilder()
    .fluidInputs(fluid('acidic_cellulose_solution') * 1000)
    .fluidInputs(fluid('acetic_acid') * 50)
    .fluidInputs(fluid('distilled_water') * 1950)
...
MIXER.recipeBuilder()
    .inputs(ore('dustCelluloseAcetate'))
    .fluidInputs(fluid('acetone') * 1000)
    .fluidOutputs(fluid('cellulose_acetate_solution') * 1000)
    .EUt(VA[LV])
    .duration(80)
    .buildAndRegister()
...
// Cumene rearranging
BR.recipeBuilder()
    .notConsumable(fluid('chloroform') * 1000)
    .inputs(ore('dustSilicaGel'))
...
FIXED_BR.recipeBuilder()
    ...
    .fluidInputs(fluid('hot_hp_propene') * 52)
...
DT.recipeBuilder()
    .fluidInputs(fluid('cleaved_cumene_mixture') * 2200)
...
DT.recipeBuilder()
    .fluidInputs(fluid('diisopropylbenzene_mixture') * 1000)
...
MIXER.recipeBuilder()
    ...
    .fluidInputs(fluid('gtfo_perchloric_acid') * 100)
    .fluidOutputs(fluid('benzenediol_catalysis_mixture') * 1100)
    .duration(50)
    .EUt(VA[LV])
    .buildAndRegister()

CSTR.recipeBuilder()
    .fluidInputs(fluid('phenol') * 200)
    .fluidInputs(fluid('benzenediol_catalysis_mixture') * 110)
    .fluidInputs(fluid('hydrogen_peroxide') * 50)
    .fluidOutputs(fluid('benzenediol_solution') * 200)
    .fluidOutputs(fluid('diluted_benzenediol_catalysis_mixture') * 160)
    .duration(5)
    .EUt(VA[LV])
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('diluted_benzenediol_catalysis_mixture') * 1600)
    .fluidOutputs(fluid('benzenediol_catalysis_mixture') * 1100)
    .fluidOutputs(fluid('water') * 500)
    .duration(50)
    .EUt(VA[LV])
...
LCR.recipeBuilder()
    ...
    .outputs(metaitem('dustEthylenediaminetetraaceticAcid') * 36)
    .fluidOutputs(fluid('ammonia') * 4000)
...
DT.recipeBuilder() // SCHULZ-FLORY, p = 0.82, ROUNDED TO NEAREST 5
...
BR.recipeBuilder()
    .inputs(ore('dustMolecularSieveA') * 10)
    .fluidInputs(fluid('tert_butyl_hydroperoxide') * 1000)
    .fluidInputs(fluid('tert_butyl_alcohol') * 1000)
    .outputs(metaitem('dustWetMolecularSieveA') * 10)
...
BCR.recipeBuilder()
    ...
    .fluidInputs(fluid('carbon_dioxide') * 50)
    .fluidOutputs(fluid('ammonium_carbonate_solution') * 50)
    .duration(4)
    .EUt(16)
    .buildAndRegister()

DISTILLERY.recipeBuilder()
    .fluidInputs(fluid('ammonium_carbonate_solution') * 1000)
    .outputs(metaitem('dustAmmoniumCarbonate') * 14)
    .fluidOutputs(fluid('water') * 1000)
    .duration(80)
    .EUt(VA[LV])
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('sodium_amalgam') * 1000)
    .duration(120)
    .EUt(VA[ULV])
    .buildAndRegister()
...
LCR.recipeBuilder()
    .fluidInputs(fluid('acetone_cyanohydrin') * 2000)
    .fluidInputs(fluid('hydrazine') * 1000)
    .fluidInputs(fluid('chlorine') * 2000)
    .outputs(metaitem('dustAzobisisobutyronitrile'))
    .fluidOutputs(fluid('hydrochloric_acid') * 2000)
    .duration(100)
    .EUt(VA[LV])
    .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .fluidInputs(fluid('formaldehyde') * 5000)
    .fluidInputs(fluid('diluted_hydrochloric_acid') * 10000)
    .outputs(metaitem('dustPenteticAcid') * 50)
...
CSTR.recipeBuilder()
    ...
    .fluidInputs(fluid('ethylenediamine') * 50)
    .fluidOutputs(fluid('n_hydroxyethyl_ethylenediamine') * 50)
    .duration(1)
    .EUt(VA[LV])
    .buildAndRegister()
...
LCR.recipeBuilder()
    .inputs(ore('dustSodiumHydroxide') * 9)
    .fluidInputs(fluid('n_hydroxyethyl_ethylenediamine') * 1000)
    .fluidInputs(fluid('formaldehyde') * 3000)
    .fluidInputs(fluid('diluted_hydrochloric_acid') * 6000)
    .outputs(metaitem('dustNHydroxyethylEthylenediaminetriaceticAcid') * 37)
...
CSTR.recipeBuilder()
    .fluidInputs(fluid('sodium_hydroxide_solution') * 50)
    .fluidInputs(fluid('water') * 50)
    .fluidOutputs(fluid('diluted_sodium_hydroxide_solution') * 100)
    .duration(10)
    .EUt(140)
    .buildAndRegister()

// Silver Sulfadiazine Chain
BR.recipeBuilder()
...
REACTION_FURNACE.recipeBuilder()
    .inputs(ore('dustAmmoniumThiocyanate') * 24)
    .outputs(metaitem('dustGuanidine') * 18)
    .fluidOutputs(fluid('hydrogen_sulfide') * 1000)
    .fluidOutputs(fluid('carbon_disulfide') * 1000)
    .duration(60)
    .EUt(120)
...
BR.recipeBuilder()
    .inputs(ore('dustGuanidiniumChloride') * 11)
...
BR.recipeBuilder()
    ...
    .outputs(metaitem('dustSulfonamideIntermediate') * 32)
    .fluidOutputs(fluid('hydrogen_chloride') * 1000)
    .duration(100)
    .EUt(120)
    .buildAndRegister()
...
BR.recipeBuilder()
    .inputs(ore('dustSulfonamideIntermediate') * 32)
    .fluidInputs(fluid('sodium_hydroxide_solution') * 1000)
    .outputs(metaitem('dustSulfadiazine') * 27)
    .fluidOutputs(fluid('sodium_acetate_solution') * 1000)
    .duration(100)
    .EUt(30)
    .buildAndRegister()

BR.recipeBuilder()
    .inputs(ore('dustSulfadiazine') * 27)
    .fluidInputs(fluid('silver_nitrate_solution') * 1000)
    .outputs(metaitem('dustSilverSulfadiazine') * 27)
    .fluidOutputs(fluid('diluted_nitric_acid') * 1000)
    .duration(100)
    .EUt(120)
    .buildAndRegister()
