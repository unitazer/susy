...
BR.recipeBuilder()
        ...
        .inputs(ore('dustSulfur') * 7)
        .inputs(ore('dustSaltpeter') * 30)
        .fluidInputs(fluid('water') * 4000)
        .fluidOutputs(fluid('chamber_acid') * 4000)
        .outputs(metaitem('dustPotassiumSulfate') * 9)
        .fluidOutputs(fluid('nitrogen_oxide') * 6000)
        .duration(160)
        .EUt(VA[ULV])
        .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .outputs(metaitem('dustTetrasodiumEthylenediaminetetraacetate') * 40)
...
MIXER.recipeBuilder()
    .inputs(ore('dustTetrasodiumEthylenediaminetetraacetate') * 40)
    .fluidInputs(fluid('water') * 1000)
    .fluidOutputs(fluid('tetrasodium_ethylenediaminetetraacetate_solution') * 1000)
    .duration(20)
    .EUt(VA[LV])
    .buildAndRegister()
