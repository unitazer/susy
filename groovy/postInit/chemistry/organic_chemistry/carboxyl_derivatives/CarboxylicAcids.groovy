...
SIEVE_DT.recipeBuilder()
    ...
    .fluidOutputs(fluid('acetaldehyde') * 30)
    .duration(80)
    .EUt(VA[LV])
    .buildAndRegister()
...
CRYSTALLIZER.recipeBuilder() // Source: Platinum Group Metals and Compounds Chapter in Ullmann's Encyclopedia of Industrial Chemistry https://doi.org/10.1002/14356007.a21_075
    ...
    .fluidOutputs(fluid('dense_steam') * 4450)
    .duration(200)
    .EUt(VA[MV])
    .buildAndRegister()
...
CSTR.recipeBuilder() // Simulates the reaction that would typically occur in-situ (Source: https://technology.matthey.com/content/journals/10.1595/003214000X44394105)
    ...
    .fluidOutputs(fluid('methyl_iodide_solution') * 100)
    .duration(10)
    .EUt(VA[LV])
    .buildAndRegister()
...
MIXER.recipeBuilder()
    ...
    .fluidOutputs(fluid('lithium_iodide_solution') * 2000)
    .fluidOutputs(fluid('monsanto_process_catalyst') * 4000)
    .duration(20)
    .EUt(VA[MV])
    .buildAndRegister()
...
MIXER.recipeBuilder()
    ...
    .fluidInputs(fluid('methyl_iodide_solution') * 2000)
    .fluidOutputs(fluid('cativa_process_catalyst') * 2000)
    .duration(20)
    .EUt(VA[MV])
    .buildAndRegister()
