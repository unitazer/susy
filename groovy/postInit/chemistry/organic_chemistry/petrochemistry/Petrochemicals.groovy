...
CSTR.recipeBuilder()
    ...
    .fluidOutputs(fluid('dimethyl_dioxane_solution') * 50)
    .duration(2)
    .EUt(VA[MV])
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('dimethyl_dioxane_solution') * 1000)
    .fluidOutputs(fluid('sulfuric_acid') * 1000)
    .fluidOutputs(fluid('water') * 1000)
    .fluidOutputs(fluid('dimethyl_one_three_dioxane') * 1000)
    .duration(200)
    .EUt(VA[MV])
    .buildAndRegister()
...
ROASTER.recipeBuilder()
    ...
    .fluidOutputs(fluid('isoprene_solution') * 1000)
    .duration(160)
    .EUt(VA[MV])
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('isoprene_solution') * 1000)
    .fluidOutputs(fluid('water') * 1000)
...
BCR.recipeBuilder()
    ...
    .notConsumable(fluid('ammonia') * 50)
